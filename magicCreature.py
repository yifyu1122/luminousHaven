...
COLOR_MIX_RULES = {
    ...
    ("紅", "藍"): [("紫", 50), ("紅", 20), ("藍", 20), ("粉", 10)],
    ("黃", "藍"): [("綠", 50), ("黃", 20), ("藍", 20), ("粉", 10)],
    ("紅", "橙"): [("橙", 40), ("紅", 40), ("黃", 10), ("粉", 10)],
    ("橙", "黃"): [("橙", 40), ("黃", 40), ("紅", 10), ("粉", 10)],   
    ("藍", "綠"): [("綠", 40), ("藍", 40),("黃", 10), ("粉", 10)],
    ("紅", "紫"): [("藍", 10), ("紫", 40), ("紅", 40), ("粉", 10)],
    ("黃", "綠"): [("黃", 40), ("綠", 40), ("藍", 10), ("粉", 10)],
    ("藍", "紫"): [("紫", 40), ("藍", 40), ("紅", 10), ("粉", 10)],
    ("紅", "綠"): [("黃", 12), ("綠", 25), ("紅", 40), ("藍", 12), ("粉", 11)],
    ("橙", "藍"): [("紅", 12), ("橙", 25),("黃", 12), ("藍", 40), ("粉", 11)],
    ("黃", "紫"): [("粉", 11), ("黃", 40), ("紫", 25), ("紅", 12), ("藍", 12)],
    ("綠", "紫"): [("綠", 40), ("紫", 40),("粉", 20)],
    ("橙", "紫"): [("粉", 20), ("橙", 40), ("紫", 40)],
    ("橙", "綠"): [("橙", 40), ("綠", 40), ("粉", 20)]
}
